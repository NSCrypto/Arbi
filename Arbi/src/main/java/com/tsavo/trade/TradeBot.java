...
public class TradeBot {
	...
	public static class Finder {
		...
		public Finder() throws ExchangeException, NotAvailableFromExchangeException, NotYetImplementedForExchangeException, IOException, InterruptedException {
			...
			//new CycleOpportunityFinder("BTC", Arrays.asList(new CurrencyPair("XRP", "BTC"), new CurrencyPair("LTC", "BTC"), new CurrencyPair("LTC", "XRP"), new CurrencyPair("DGC",
            //        "XRP"), new CurrencyPair("DGC", "BTC"), new CurrencyPair("DGC", "LTC")), portfolio).findOpportunities(executor);
